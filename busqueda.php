...
<p class="text-center text-sucsess fs-3">No se encontraron resultados con el termino de busqueda <?= $termino_busqueda ?> </p>
<?php }else { ?>
<p class="text-center text-sucsess fs-3">El campo de busqueda no puede estar vacio</p>
<?php } ?>
