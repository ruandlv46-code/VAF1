    ...
    <div class="row d-flex justify-content-between mb-5">
        ...
        <div class="card" style="width: 13rem;">
            <a href="previews.php?categoria=personajes">
                <div class="card-body">
                    <h5 class="titulocarta card-title text-center">PERSONAJES</h5>
                </div>
                <div>
        ...
        <div class="card" style="width: 13rem;">
            <a href="peliculas.php">
                <div class="card-body">
                    <h5 class="titulocarta card-title text-center">PELICULAS</h5>
        ...
        <div class="card" style="width: 13rem;">
            <a href="previews.php?categoria=vehiculos">
                <div class="card-body">
                    <h5 class=" titulocarta card-title text-center">VEHICULOS</h5>
        ...
        <div class="card" style="width: 13rem;">
            <a href="preview2.php?categoria=tiempo">
                <div class="card-body">
                    <h5 class="titulocarta card-title text-center">LINEA DEL TIEMPO</h5>
        ...
        <div class="card" style="width: 13rem;">
            <a href="preview2.php?categoria=cameos">
                <div class="card-body">
                    <h5 class="titulocarta card-title text-center">CAMEOS</h5>
